...
class Roles extends RestrictedBaseController
{
    ...
    public function index()
    {
        if(user_has_access($this->controller,__FUNCTION__))
        {
            ...
            //============================================================================================
            $advanced_search_fields[]=$this->advanced_search->get_text_search(array('label'=>'Role ID','name'=>'id','type'=>'number'));
            $advanced_search_fields[]=$this->advanced_search->get_checklist_search(array('label'=>'Role Type','name'=>'role_type','options'=>array('Admin','Basic','Normal')));
            $advanced_search_fields[]=$this->advanced_search->get_checklist_search(array('label'=>'Role Status','name'=>'status','options'=>get_statuses_array()));
    ...
    public function view_role($id=0)
    {
        if(user_has_access($this->controller,__FUNCTION__))
        {
            $fields=array('id','creator_id','role','role_type','status','rights','comment','users.first_name','users.other_names');
