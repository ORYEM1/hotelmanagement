...
function get_advanced_search_button($params=array())
{
    $config['element']='link';
    $config_params['class']='button button-primary';
    $config_params['href']='#advanced_search';
    $config_params['rel']='modal:open';
    $config['params']=$config_params;
    $icon=isset($params['icon'])?"<i class='{$params['icon']}'></i>":"<i class='fa fa-search-plus'></i>";
    $label=$params['label']??'Advanced Search';
