...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo '/resources/css/themes/'.$_SESSION['theme'].'.css';?>">
    ...
    <header id="page_header">
        ...
        <div id="header_container">
            ...
            <div id="logo_container">
                <div id="logo">
                    <a href="<?php echo base_url() ?>">Mobile Pay <img src="/resources/images/logo.png" alt="Logo"></a>
                </div>
            </div>
        </div>
    ...
    <footer id="page_footer">
        <p> Copyright &copy; Code Base Limited</p>
    </footer>
    <!-- End of #footer -->
